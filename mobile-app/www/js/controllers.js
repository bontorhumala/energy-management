var app = angular.module('starter.controllers', [])
  ...
  app.controller('DashboardCtrl', function($scope, $ionicModal, $timeout, $templateCache, $filter, $http) {
  ...
  app.controller('ControlCtrl', function($scope, $ionicModal, $timeout, $templateCache, $filter, $http) {
    // Form data for the login modal
    $scope.loginData = {};
